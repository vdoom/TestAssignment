...
void ctClickablePlane::GettingLineAttributes()
{
    ...
    posAtribLoc   = m_lineShader->attributeLocation("_POSITION");
    colorUniformLoc = m_lineShader->uniformLocation("_COLOR");
    matrixUniform = m_lineShader->uniformLocation("_VIEWPROJECTIONMATRIX");
    transformMatrixUniform = m_lineShader->uniformLocation("_TRANSFORMMATRIX");
    lineMaterialUniform = m_lineShader->uniformLocation("_MATERIAL");
...
void ctClickablePlane::DrawRectLines()
{
    ...
    m_lineShader->setUniformValue(lineMaterialUniform, m_rectColor);
